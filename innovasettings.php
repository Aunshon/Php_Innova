<?php
 ...
 $getuserQueryFromDatabase="SELECT * FROM inovalogo";
   ...
   foreach ($alldataresult as $value) {
    ?> -->
     <tr>
       ...
       <td><img src="uploads/inovalogo/<?php echo $value['photo']; ?>" alt=""width="100"></td>
       <td>
         <?php
            if ($value['status']==1) {
              // echo $value['status'];
              ?>
              <a href="inovaca.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="Activeted" class="btn btn-success"></a>
              <?php
            }
            else {
              ?>
              <a href="inovaca.php?id=<?php echo $value['id']; ?>&status=<?php echo $value['status']; ?>"><input type="submit" name="" value="DeActived" class="btn btn-danger"></a>
...
<h1>Add Innova Logo</h1>
<div>
  <form action="inovalogopost.php" method="post" enctype="multipart/form-data">
